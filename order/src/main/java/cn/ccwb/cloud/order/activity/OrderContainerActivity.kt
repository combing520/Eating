package cn.ccwb.cloud.order.activity
 ...
 * 订单
 */
@Route(path = RouterPath.PAGE_GUIDE_ORDER)
class OrderContainerActivity : BaseActivityPlusWithoutPresenter() {
    ...
    private fun initStatusBar(isFitSystem: Boolean) {
        ImmersionBar.with(this@OrderContainerActivity)
