package cn.ccwb.cloud.usercenter.activity
...
@Route(path = RouterPath.PAGE_GUIDE_USERCENTER)
class UserCenterContainerActivity: BaseActivityPlusWithoutPresenter() {
    ...
    private fun initStatusBar(isFitSystem: Boolean) {
        ImmersionBar.with(this@UserCenterContainerActivity)
